...
COINGECKO_MIN_SECONDS_BETWEEN_CALLS: float = 0.5

OUTPUT_TXT_FILENAME: str = "listingtabledata.txt"  # legacy, no longer written
OUTPUT_CSV_FILENAME: str = "listingtabledata.csv"  # legacy, no longer written
...
def _request_json_with_retries(
    ...
    for attempt in range(retries):
        try:
            ...
            time.sleep(max(COINGECKO_MIN_SECONDS_BETWEEN_CALLS, 1.0 + attempt * 1.0))
